...
public class Grupo {
	...
	public void setHoraDelDia(Date hora) {
	...
	public Grupo(List<String> diasSemana,Date horaDelDia, Profesor dictadoPor, String salon, Curso cursoAsociado, int numeroDeGrupo, int cantidadEstudiantes) {
	...
	public Grupo(List<String> diasSemana,Date horaDelDia, Profesor dictadoPor, String salon, Curso cursoAsociado, int numeroDeGrupo) {
		this(diasSemana, horaDelDia, dictadoPor, salon,cursoAsociado,numeroDeGrupo, 0);
	}
	
	public Grupo(List<String> diasSemana,Date horaDelDia, Profesor dictadoPor, String salon, Curso cursoAsociado) {
		this(diasSemana, horaDelDia, dictadoPor, salon,cursoAsociado,0, 0);
	}
	
	public Grupo(List<String> diasSemana,Date horaDelDia, Profesor dictadoPor, String salon) {
		this(diasSemana, horaDelDia, dictadoPor, salon,null,0, 0);
	}
	
	public Grupo(List<String> diasSemana,Date horaDelDia, Profesor dictadoPor) {
		this(diasSemana, horaDelDia, dictadoPor, null,null,0, 0);
	}

	public Grupo(List<String> diasSemana,Date horaDelDia) {
