...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        Grupo grupo1Calculo = new Grupo(diasGrupo1Calculo, null, p0001, "Salon 401", precalculo, 1, 27);
        Grupo grupo2Calculo = new Grupo(diasGrupo2Calculo, null, p0001, "Salon 401", precalculo, 2, 25);

        Grupo grupo1Mecanica = new Grupo(diasGrupo1Mecanica, null, p0002, "Salon 203", mecanica, 12, 32);
        Grupo grupo2Mecanica = new Grupo(diasGrupo2Mecanica, null, p0002, "Salon 203", mecanica, 23, 28);
